...
public class DetailKomisariFormular extends javax.swing.JFrame {

    public DetailKomisariFormular(Komisari komisar) {
        this();

        txtMeno.setText(komisar.getMeno());
        txtPriezvisko.setText(komisar.getPriezvisko());
        txtKontakt.setText(komisar.getHodnost());
    }

    /**
     * Creates new form DetailInstruktorFormular
     */
    private DetailKomisariFormular() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailKomisariFormular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailKomisariFormular().setVisible(true);
            }
        });
    }
