...
public class SqlQueries {
    ...
    public static final String SELECT_ALL_SKUSKA = "SELECT \n"
            ...
            + "    Skuska.komisarId AS SkuskaKomisarId,\n"
            + "    Skuska.komisarId AS SkuskaKomisarId,\n"
            + "    Komisari.id AS KomisarId,\n"
            + "    Komisari.meno AS KomisarMeno,\n"
            + "    Komisari.priezvisko AS KomisarPriezvisko,\n"
            + "    Komisari.hodnost AS KomisarHodnost,\n"
            + "    Instruktor.id AS InstruktorId,\n"
            + "    Instruktor.meno AS InstruktorMeno,\n"
            + "    Instruktor.priezvisko AS InstruktorPriezvisko,\n"
            + "    Instruktor.kontakt AS InstruktorKontakt\n"
            ...
            + "JOIN Komisari ON Skuska.komisarId = Komisari.id\n";
    ...
    public static final String SELECT_SKUSKA_BY_STUDENT = "SELECT \n"
            ...
            + "    Instruktor.kontakt AS InstruktorKontakt\n"
            + "FROM Skuska\n"
            + "JOIN Instruktor ON Skuska.instruktorId = Instruktor.id JOIN Komisari ON Skuska.komisarId = Komisari.id \n"
            + "WHERE Skuska.id IN (\n"
            + "    SELECT\n"
    ...
    public static final String SELECT_ALL_KOMISARI = "SELECT     \n"
            + "    Komisari.id AS KomisarId,\n"
            + "    Komisari.meno AS KomisarMeno,\n"
            + "    Komisari.priezvisko AS KomisarPriezvisko,\n"
            + "    Komisari.hodnost AS KomisarHodnost\n"
    ...
    public static final String SELECT_KOMISARI_BY_MENO = "SELECT \n"
            + "    Komisari.id AS KomisarId,\n"
            + "    Komisari.meno AS KomisarMeno,\n"
            + "    Komisari.priezvisko AS KomisarPriezvisko,\n"
            + "    Komisari.hodnost AS KomisarHodnost\n"
            + "FROM Komisari\n"
            + "WHERE Komisari.meno LIKE ?;";
    
    public static final String SELECT_KOMISARI_BY_PRIEZVISKO = "SELECT \n"
            + "    Komisari.id AS KomisarId,\n"
            + "    Komisari.meno AS KomisarMeno,\n"
            + "    Komisari.priezvisko AS KomisarPriezvisko,\n"
            + "    Komisari.hodnost AS KomisarHodnost\n"
            + "FROM Komisari\n"
            + "WHERE Komisari.priezvisko LIKE ?;";
    
    public static final String SELECT_KOMISARI_BY_HODNOST = "SELECT \n"
            + "    Komisari.id AS KomisarId,\n"
            + "    Komisari.meno AS KomisarMeno,\n"
            + "    Komisari.priezvisko AS KomisarPriezvisko,\n"
            + "    Komisari.hodnost AS KomisarHodnost\n"
            + "FROM Komisari\n"
            + "WHERE Komisari.hodnost LIKE ?;";
}
